...
public class SelectSchoolActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mSearchBox = (EditText) findViewById(R.id.txtBox);
		mSearchBox.addTextChangedListener(new TextWatcher() {
			...
			public void afterTextChanged(Editable arg0) {
				if (arg0.toString().length() > 0) {
					...
					showProgress(true);
					(mRetrieveTask = new RetrieveSchoolsTask()).execute(arg0.toString());
				}
			}
		...
		mSchoolsList = (ListView) findViewById(R.id.schools_listview);
		...
		mSearchLayout = (LinearLayout) findViewById(R.id.select_school_status);
	}
			...
			try {
				...
				DefaultHandler handler = new DefaultHandler() {
					...
					public void endElement(String uri, String localName, String qName) throws SAXException {
						...
						else if (qName.equalsIgnoreCase("licentie")) currentSchool.License = currentValue;
					}
